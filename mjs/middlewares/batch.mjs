...
export var RRNLBatchMiddlewareError =
/*#__PURE__*/
function (_RRNLError) {
  _inheritsLoose(RRNLBatchMiddlewareError, _RRNLError);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 11:
            ...
            batchRequest = new RelayRequestBatch(ids.map(function (id) {
              return requestMap[id].req;
            })); // $FlowFixMe

            _context.next = 15;
            return isFunction(opts.batchUrl) ? opts.batchUrl(requestMap) : opts.batchUrl;

          case 15:
            url = _context.sent;
            batchRequest.setFetchOption('url', url);
            _opts$fetchOpts = opts.fetchOpts, headersOrThunk = _opts$fetchOpts.headersOrThunk, fetchOpts = _objectWithoutPropertiesLoose(_opts$fetchOpts, ["headersOrThunk"]);
            ...
            _context.next = 22;
            return isFunction(headersOrThunk) ? headersOrThunk(batchRequest) : headersOrThunk;
